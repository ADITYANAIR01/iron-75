...
const OFFLINE_TIPS: Record<ChallengeId, string[]> = {
  tip: [
    ...
    "Micro-wins compound into macro-results. That extra glass of water, those 10 pages, that walk when it was raining — they all stack into an unstoppable version of you. 🏆",
    "Your real competition is the version of you that wanted to skip today. Beat that person daily and watch who you become by Day 75. 🔥",
    ...
    "Your hydration status determines your focus level. At just 2% dehydration, cognitive performance drops measurably. 3.8L isn't a goal — it's a baseline. 💧",
  ...
  pattern: [
    ...
    "Data insight: water intake is your biggest performance lever. On 3.8L+ days, energy scores jump an average of 40% compared to under-hydrated days. Fill the bottle before you fill your plate. 💧",
  ...
  motivation: [
    ...
    "This isn't a fitness challenge anymore — it's a character test. Every rep, every page, every glass of water is a vote for who you're becoming. The temporary discomfort is building permanent identity. The version of you on Day 75 will be unrecognizable. Now move. 🔥💎",
